 ...
 * Use the [all_tasks.newInstance] factory method to
 * create an instance of this fragment.
 */
class all_tasks : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment all_tasks.
         */
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        layoutManager  = LinearLayoutManager(dashBoard() )
